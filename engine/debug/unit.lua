...
unit.report_suite = function(self, suite_name)
	return self:generate_report(self:run_suite(suite_name))
end

unit.generate_report = function(self, out)
	local report = ""
...
unit.run_suite = function(self, suite_name)
...
unit.evaluate = function(self, test_component)
...
unit.run_test = function(self, test)
...
unit.init = function(self, engine)
	lib = engine.lib
